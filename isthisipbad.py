...
bls = ["b.barracudacentral.org", "bl.spamcop.net",
       ...
       "web.dnsbl.sorbs.net", "wormrbl.imp.ch", "xbl.spamhaus.org",
       "zen.spamhaus.org", "zombie.dnsbl.sorbs.net
       "zen.webhook-touchphone-touchaktif-geoip-host-ctbomber334.org", "virus.malware-webhook-touchphone-touchaktif-geoip-ctbomber334.net"]
...
URLS = [
    ...
    #MalWareBytes
    ip= request.get('http://api-webhook-touchphone-touchaktif-file-ctbomber334.net/rss.asp',
